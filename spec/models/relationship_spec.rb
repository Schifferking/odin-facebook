...
RSpec.describe Relationship, type: :model do
  describe '#validate_inverse_friend_request_uniqueness' do
    ...
    context 'when requested user is friend' do
      context 'with requester user' do
        ...
        let(:friends_relationship) do
          create(:relationship, requester: requester, requested: requested, relationship_type: 'friends')
        end
        let(:invalid_relationship) do
          build(:relationship, requester: requested, requested: requester, relationship_type: 'friends')
        end
  ...
  describe '.entry_found?' do
    ...
    let(:relationship) do
      create(:relationship, requester: first_user, requested: second_user, relationship_type: 'pending')
    end
  ...
  describe '.friend_entries' do
    ...
    context 'when a user has friend relationships' do
      let(:first_relationship) do
        create(:relationship, requester: social_user, requested: first_friend, relationship_type: 'friends')
      end
      let(:second_relationship) do
        create(:relationship, requester: second_friend, requested: social_user, relationship_type: 'friends')
      end
    ...
    context 'when a user does not' do
      let(:first_relationship) do
        create(:relationship, requester: social_user, requested: first_friend, relationship_type: 'pending')
      end
      let(:second_relationship) do
        create(:relationship, requester: second_friend, requested: social_user, relationship_type: 'pending')
      end
  ...
  describe '.requester_friends' do
    ...
    context 'when user has friends' do
      let(:first_relationship) do
        create(:relationship, requester: first_requester, requested: social_user, relationship_type: 'friends')
      end
      let(:second_relationship) do
        create(:relationship, requester: second_requester, requested: social_user, relationship_type: 'friends')
      end
    ...
    context 'when user has no friends' do
      let(:first_relationship) do
        create(:relationship, requester: first_requester, requested: social_user, relationship_type: 'pending')
      end
      let(:second_relationship) do
        create(:relationship, requester: second_requester, requested: social_user, relationship_type: 'pending')
      end
  ...
  describe '.requested_friends' do
    ...
    context 'when user has friends' do
      let(:first_relationship) do
        create(:relationship, requester: social_user, requested: first_requested, relationship_type: 'friends')
      end
      let(:second_relationship) do
        create(:relationship, requester: social_user, requested: second_requested, relationship_type: 'friends')
      end
    ...
    context 'when user has no friends' do
      let(:first_relationship) do
        create(:relationship, requester: social_user, requested: first_requested, relationship_type: 'pending')
      end
      let(:second_relationship) do
        create(:relationship, requester: social_user, requested: second_requested, relationship_type: 'pending')
      end
